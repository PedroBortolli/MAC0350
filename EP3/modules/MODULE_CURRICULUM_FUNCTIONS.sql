...
CREATE OR REPLACE FUNCTION seleciona_curriculo(INTEGER) RETURNS TABLE(cod INTEGER, nome VARCHAR(50))
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION atualiza_curriculo(INTEGER, VARCHAR(50)) RETURNS VOID
LANGUAGE plpgsql
AS $$
BEGIN
	UPDATE curriculo
